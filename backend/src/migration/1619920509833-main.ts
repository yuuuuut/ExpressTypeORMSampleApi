...
export class main1619920509833 implements MigrationInterface {
    name = 'main1619920509833'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `relationships` (`followed_id` varchar(255) NOT NULL, `follower_id` varchar(255) NOT NULL, INDEX `IDX_88419243671c0faad35302ef52` (`followed_id`), INDEX `IDX_04e920a07eea34bdb48c9a0f3c` (`follower_id`), PRIMARY KEY (`followed_id`, `follower_id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("DROP INDEX `IDX_04e920a07eea34bdb48c9a0f3c` ON `relationships`");
        await queryRunner.query("DROP INDEX `IDX_88419243671c0faad35302ef52` ON `relationships`");

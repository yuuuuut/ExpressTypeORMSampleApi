...
export class user1618753373949 implements MigrationInterface {
    name = 'user1618753373949'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `rooms` (`id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `profiles` (`id` int NOT NULL AUTO_INCREMENT, `line_id` varchar(255) NOT NULL, `twitter_id` varchar(255) NOT NULL, `user_id` varchar(255) NULL, UNIQUE INDEX `REL_9e432b7df0d182f8d292902d1a` (`user_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `messages` (`id` int NOT NULL AUTO_INCREMENT, `kind` varchar(255) NOT NULL, `isApproval` tinyint NOT NULL DEFAULT 0, `rejected` tinyint NOT NULL DEFAULT 0, `user_id` varchar(255) NOT NULL, `room_id` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `entries` (`id` int NOT NULL AUTO_INCREMENT, `send_message_count` int NOT NULL DEFAULT '0', `user_id` varchar(255) NULL, `room_id` int NULL, UNIQUE INDEX `IDX_1cc4b9d21763133c30eddf3913` (`user_id`, `room_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
